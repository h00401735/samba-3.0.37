...
static WERROR rcinit_stop( const char *service, SERVICE_STATUS *status )
{
	...
	pstr_sprintf( command, "%s/%s/%s stop", LIBDIR, SVCCTL_SCRIPT_DIR, service );
...
static WERROR rcinit_start( const char *service )
{
	...
	pstr_sprintf( command, "%s/%s/%s start", LIBDIR, SVCCTL_SCRIPT_DIR, service );
...
static WERROR rcinit_status( const char *service, SERVICE_STATUS *status )
{
	...
	pstr_sprintf( command, "%s/%s/%s status", LIBDIR, SVCCTL_SCRIPT_DIR, service );
